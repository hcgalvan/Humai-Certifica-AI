...
class Draw():
    ...
    def __init__(self, width, height) -> None:
        self.width = width
        self.height = height
        self.font = ImageFont.truetype('/home/hcgalvan/hcgmachlearn-gd/Humai-Certifica-AI/test/mrpose-2/mrpose_2/data/fonts/arial.ttf', self.height//24, encoding="unic")
